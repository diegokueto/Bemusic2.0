...
<html>
    <head>
        ...
        /*Coloca el texto sobre las imágenes*/
        .contenedor{
            position: relative;
    ...
    <div class="contenedor">
      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRXaHjA1H52idMrVZVwATilfs8mjZjtxygjHw&usqp=CAU" height="350" width="100%">
        <h2><div class="centrado"><a class="navbar-brand" href="">Comunidad</a></div></h2>
      </div>
    <br>
    <div class="contenedor">
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQtC1_yQ21C9VYZBwwlvlSf5j8vZNrWHt3xBg&usqp=CAU" height="350" width="100%">
    <h2><div class="centrado"><a class="navbar-brand" href="{{ url('/servicios') }}">Nuestros servicios</a></div></h2>
    </div>
    <br>
      <div class="contenedor">
      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRXaHjA1H52idMrVZVwATilfs8mjZjtxygjHw&usqp=CAU" height="350" width="100%">
        <h2><div class="centrado"><a class="navbar-brand" href="{{ url('/instrumento') }}">Orden y Concierto</a></div></h2>
      </div>
    <br>
    <div class="contenedor">
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQtC1_yQ21C9VYZBwwlvlSf5j8vZNrWHt3xBg&usqp=CAU" height="350" width="100%">
    <h2><div class="centrado"><a class="navbar-brand" href="{{ url('/información') }}">Información</a></div></h2>
    </div>
    <br>
    </body>
</html>
